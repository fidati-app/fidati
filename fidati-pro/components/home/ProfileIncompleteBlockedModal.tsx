...
export function ProfileIncompleteBlockedModal({ visible, onDismiss }: Props) {
      ...
      <Animated.View entering={elegantFadeIn} exiting={elegantFadeOut} style={styles.backdrop}>
        ...
        <Animated.View entering={elegantZoomIn(220)} style={styles.sheet}>
          ...
          <View style={styles.iconWrap}>
            <Ionicons name="document-text-outline" size={28} color={Colors.pending} />
          </View>
          <AppText style={styles.title}>Completa prima il profilo</AppText>
          <AppText style={styles.body}>
            Potrai renderti disponibile appena la verifica sarà completata.
          </AppText>
