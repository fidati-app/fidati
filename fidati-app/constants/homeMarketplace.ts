...
export const POPULAR_SERVICES: PopularService[] = [
  ...
  },
  {
    ...
    completedJobs: 1960,
    avgPrice: 45,
    imageUrl: 'https://images.unsplash.com/photo-1607472586893-edb57bdc0e39?w=400&h=300&fit=crop',
  },
  {
    id: 'ps3',
    title: 'Elettricista',
...
export const HOME_SERVICES_CASA: HomeServiceTile[] = [
  ...
  { id: 'c6', title: 'Montaggio mobili', icon: 'hammer-outline', slug: 'tuttofare' },
  { id: 'c7', title: 'Imbiancatura', icon: 'color-palette-outline', slug: 'tuttofare' },
  { id: 'c8', title: 'Serrature', icon: 'key-outline', slug: 'tuttofare' },
  { id: 'c9', title: 'Climatizzatori', icon: 'snow-outline', slug: 'elettricisti' },
  { id: 'c10', title: 'Traslochi', icon: 'car-outline', slug: 'tuttofare' },
];
...
export const HOME_SERVICES_AZIENDA: HomeServiceTile[] = [
  ...
  { id: 'a7', title: 'Condizionatori', icon: 'snow-outline', slug: 'elettricisti' },
  { id: 'a8', title: 'Facchinaggio', icon: 'cube-outline', slug: 'tuttofare' },
  { id: 'a9', title: 'Facility management', icon: 'settings-outline', slug: 'tuttofare' },
  { id: 'a10', title: 'Manutenzione impianti', icon: 'build-outline', slug: 'tuttofare' },
];
...
export const HOME_PROMO_BANNERS: HomePromoBanner[] = [
  {
    ...
    subtitle: 'Oltre 2.400 professionisti selezionati in tutta Italia',
  },
  {
    id: 'b2',
    icon: 'flash',
    ...
    title: 'Interventi urgenti entro 1 ora',
    subtitle: 'Trova subito chi può aiutarti',
  },
  {
    id: 'b3',
    icon: 'star',
    ...
    title: 'Migliaia di recensioni reali',
